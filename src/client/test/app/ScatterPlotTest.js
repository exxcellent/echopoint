/**
 * A test class for the echopoint.google.ScatterPlot client-side component.
...
echopoint.test.ScatterPlotTest = Core.extend(
{
  ...
  _createChart: function()
  {
    ...
    var title = new echopoint.google.model.Title( "ScatterPlot" );

    return new echopoint.google.ScatterPlot(
    {
