/**
 * A test class for the echopoint.google.Sparkline client-side component.
...
echopoint.test.SparklineTest = Core.extend(
{
  ...
  _createSimple: function()
  {
    ...
    return new echopoint.google.Sparkline(
    {
  ...
  _createComplex: function()
  {
    ...
    var title = new echopoint.google.model.Title( "Complex Sparkline" );
