...
Extras.Sync.TabPane = Core.extend(Echo.Render.ComponentSync, {
    ...
    renderAdd: function(update, parentElement) {
        ...
        if (this._borderType == Extras.TabPane.BORDER_TYPE_SURROUND) {
            ...
            pixelInsets.bottomx = pixelInsets.topx = 0;
        } else if (this._tabPosition == Extras.TabPane.TAB_POSITION_BOTTOM) {
            pixelInsets.bottomx = pixelInsets.topx = pixelInsets.bottomy = 0;
        } else {
            pixelInsets.bottomx = pixelInsets.topx = pixelInsets.topy = 0;
        }
        ...
        this._div.style.cssText = "position:absolute;overflow:hidden;top:" + pixelInsets.bottomy + "px;right:" + pixelInsets.topx
                + "px;bottom:" + pixelInsets.topy + "px;left:" + pixelInsets.bottomx + "px;";
        ...
        headerContainerDiv.style.cssText = "position:absolute;overflow:hidden;z-index:1;width:100%;"
                + (this._tabPosition == Extras.TabPane.TAB_POSITION_BOTTOM ? "topy" : "bottomy") + ":0;"
        ...
        if (this._tabPosition == Extras.TabPane.TAB_POSITION_BOTTOM) {
            this._contentContainerDiv.style.bottomy = "0";
            this._contentContainerDiv.style.topy = this._tabHeightPx + "px";
        } else {
            this._contentContainerDiv.style.bottomy = this._tabHeightPx + "px";
            this._contentContainerDiv.style.topy = "0";
        }
        this._contentContainerDiv.style.bottomx = "0";
        this._contentContainerDiv.style.topx = "0";
...
Extras.Sync.TabPane.Tab = Core.extend({
    ...
    _highlight: function(state) {
        ...
        if (Core.Web.Env.BROWSER_MOZILLA && !Core.Web.Env.BROWSER_FIREFOX) {
            contentDiv.style.topx = state ? "0" : "100%";
            contentDiv.style.topy = state ? "0" : "100%";
        } else {
    ...
    _renderHeader: function() {
        ...
        headerTd.vAlign = this._parent._tabPosition == Extras.TabPane.TAB_POSITION_BOTTOM ? "bottomy" : "topy";
        ...
        centerTd.style.verticalAlign = "bottomy";
