 ...
 */
echopoint.google.model.ChartData = Core.extend(
{
...
echopoint.google.model.Title = Core.extend(
{
...
echopoint.google.model.Range = Core.extend(
{
 ...
 */
echopoint.google.model.LineStyle = Core.extend(
{
 ...
 * for specifications.
 */
echopoint.google.internal.Marker = Core.extend(
{
  $abstract: true,
 ...
 */
echopoint.google.model.ShapeMarker = Core.extend(
 ...
 * specifications.
 */
echopoint.google.model.FillArea = Core.extend(
    echopoint.google.internal.Marker,
{
