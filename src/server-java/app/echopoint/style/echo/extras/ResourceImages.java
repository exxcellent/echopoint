...
{
  /** The accordion pane tab background image. */
  public static final ImageReference AccordionPaneTabBackground =
      new ResourceImageReference(
          "resource/images/extras/TabBackground.png" );

  /** The accordion pane tab rollover background image. */
  public static final ImageReference AccordionPaneTabRollover =
      new ResourceImageReference(
          "resource/images/extras/TabBackgroundRollover.png" );
